  ...
  <div class="main-container">
    <div class="text-container">
      ...
      <div class="btn-container">
        <router-link :to="{ name: 'Locationform' }" class="main-btn"
      ...
      <table class="table-container">
        ...
        <tbody>
          <tr v-for="location in locations" :key="location.id">
            ...
            <div class="btn">
              <button @click="popupOpen('display')" type="submit">
                Delete
              </button>
            </div>
          </tr>
    ...
    >
      <div class="popup-content">
        ...
        <button class="popup-btn" @click="deletefunc(location.id)">
          delete
        </button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    deletefunc(x) {
      ...
      fetch(
        "http://192.241.157.30/activity/viewset/location/" + x + "/",
        options
      )
        .then((res) => res.json())
